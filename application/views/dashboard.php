                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-vertical mb-0">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <img src="<?php echo base_url('')?>assets/images/users/avatar-2.jpg" alt="user-image" class="thumb-sm rounded-circle mr-2"/>
                                                            Herbert C. Patton
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <img src="<?php echo base_url('')?>assets/images/users/avatar-3.jpg" alt="user-image" class="thumb-sm rounded-circle mr-2"/>
                                                            Mathias N. Klausen
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <img src="<?php echo base_url('')?>assets/images/users/avatar-4.jpg" alt="user-image" class="thumb-sm rounded-circle mr-2"/>
                                                            Nikolaj S. Henriksen
                                                        </td>
                                                        <td><i class="mdi mdi-checkbox-blank-circle text-success"></i> Confirm</td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <img src="<?php echo base_url('')?>assets/images/users/avatar-5.jpg" alt="user-image" class="thumb-sm rounded-circle mr-2"/>
                                                            Lasse C. Overgaard
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <img src="<?php echo base_url('')?>assets/images/users/avatar-6.jpg" alt="user-image" class="thumb-sm rounded-circle mr-2"/>
                                                            Kasper S. Jessen
                                                        </td>
                                                        <td><i class="mdi mdi-checkbox-blank-circle text-success"></i> Confirm</td>
                                                        <td>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-vertical mb-0">
                                                    ...
                                                    <tr>
                                                        <td>#12354781</td>
                                                        <td>
                                                            <img src="<?php echo base_url('')?>assets/images/products/1.jpg" alt="user-image" style="height: 46px;" class="rounded mr-2" />
                                                    ...
                                                    <tr>
                                                        <td>#52140300</td>
                                                        <td>
                                                            <img src="<?php echo base_url('')?>assets/images/products/2.jpg" alt="user-image" style="height: 46px;" class="rounded mr-2" />
                                                    ...
                                                    <tr>
                                                        <td>#96254137</td>
                                                        <td>
                                                            <img src="<?php echo base_url('')?>assets/images/products/3.jpg" alt="user-image" style="height: 46px;" class="rounded mr-2" />
                                                    ...
                                                    <tr>
                                                        <td>#12365474</td>
                                                        <td>
                                                            <img src="<?php echo base_url('')?>assets/images/products/4.jpg" alt="user-image" style="height: 46px;" class="rounded mr-2" />
                                                    ...
                                                    <tr>
                                                        <td>#85214796</td>
                                                        <td>
                                                            <img src="<?php echo base_url('')?>assets/images/products/5.jpg" alt="user-image" style="height: 46px;" class="rounded mr-2" />
                                                            BeoPlay Speaker
                                                        </td>
                                                        <td><span class="badge badge-pill badge-success">Delivered</span></td>
                                                        <td>
